...
import { loginAction, AuthActionResult } from '../actions';
import { Sparkles, UtensilsCrossed, AlertCircle, ArrowRight, Loader2 } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-stone-600 dark:text-stone-400 mt-2">
            Control de inventario doméstico inteligente y anti-desperdicio
          </p>
        </div>
        ...
        <div className="mt-8 grid grid-cols-3 gap-2 text-center text-[11px] text-stone-500 dark:text-stone-400">
          <div className="bg-white/80 dark:bg-stone-900/60 p-2.5 rounded-xl border border-stone-200/60 dark:border-stone-800">
            ⚡ Escaneo IA
          </div>
          <div className="bg-white/80 dark:bg-stone-900/60 p-2.5 rounded-xl border border-stone-200/60 dark:border-stone-800">
            🚦 Semáforo 48h
