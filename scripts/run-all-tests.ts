...
try {
  ...
  execSync('npx tsx scripts/verify-canasta-basica.ts', { stdio: 'inherit' });
  console.log('================================================================');
  console.log('🏆 ¡TODAS LAS SUITES Y PRECIOS DE SUPERMERCADO HAN SIDO VERIFICADOS Y VALIDADOS CON ÉXITO!');
  console.log('================================================================');
} catch (err) {
